...
(560, 'zadmin_organizationMember@cypress.test', NULL, NULL, 1, '2000-01-01 12:00:00', '2000-01-01 12:00:00', 562),

-- Starts without an organization, then receives 563 (group 247)
(561, 'zadmin_organizationAssignTarget@cypress.test', NULL, NULL, 1, '2000-01-01 12:00:00', '2000-01-01 12:00:00', NULL),

-- Starts in 563 (group 247), then gets unassigned
(562, 'zadmin_organizationUnassignTarget@cypress.test', NULL, NULL, 1, '2000-01-01 12:00:00', '2000-01-01 12:00:00', 563);
